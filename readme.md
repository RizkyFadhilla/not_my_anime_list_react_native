...
- server postgreSQL = https://mobileserverpostgresql-production.up.railway.app/
- server mongoDb = https://mobileservermongodb-production.up.railway.app/
- orchestra graphQL = https://orchestragraphql-production.up.railway.app/
- mobile APP = https://expo.dev/@rizkyfadhillayanuardi/client-mobile?serviceType=classic&distribution=expo-go
